...
from .models import admin_db, AdminUser, Role
from .views import AdminsView
import hashlib
import urllib

admins_store = SQLAlchemyUserDatastore(admin_db, AdminUser, Role)
...
class AdminLte(Admin):
    ...
    def __init__(self, app = None, name = None, url = None, subdomain = None, index_view = None,
        ...
        self.add_view(AdminsView(AdminUser, admin_db.session, name = "Adminstrators", menu_icon_value = 'fa-user-secret'))
